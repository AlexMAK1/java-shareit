...
class GetRejectedUserBookingsTest {
    ...
    void setUp() {
        ...
        bookingGenerator = new GetRejectedUserBookings(userRepository, bookingRepository, itemRepository);
    }
    ...
    void getUserBookings() {
        ...
        when(bookingRepository.findAllByBookerAndStatusEquals(any(), any()))
    ...
    void getOwnerBookings() {
        ...
        when(bookingRepository.findByItemAndStatusEquals(any(), any()))
                .thenReturn(booking);
