...
class GetPastUserBookingsTest {
    ...
    void setUp() {
        ...
        bookingGenerator = new GetPastUserBookings(userRepository, bookingRepository, itemRepository);
    }
    ...
    void getUserBookings() {
        ...
        when(bookingRepository.findAllByBookerAndEndBefore(any(), any()))
    ...
    void getOwnerBookings() {
        ...
        when(itemRepository.findDistinctTopByOwner(any()))
                .thenReturn(item1);
        when(bookingRepository.findAllByItemAndEndBefore(any(), any()))
                .thenReturn(List.of(booking));
