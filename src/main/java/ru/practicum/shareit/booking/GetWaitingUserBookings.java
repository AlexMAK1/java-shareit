...
@Slf4j
@Component("WAITING")
public class GetWaitingUserBookings implements BookingGenerator {
    ...
    @Autowired
    public GetWaitingUserBookings(UserRepository userRepository, BookingRepository bookingRepository, ItemRepository itemRepository) {
