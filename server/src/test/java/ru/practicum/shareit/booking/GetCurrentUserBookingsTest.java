...
class GetCurrentUserBookingsTest {
    ...
    void setUp() {
        ...
        bookingGenerator = new GetCurrentUserBookings(userRepository, bookingRepository, itemRepository);
    }
    ...
    void getUserBookings() {
        ...
        when(bookingRepository.findAllByBookerAndStartBeforeAndEndAfter(any(), any(), any()))
    ...
    void getOwnerBookings() {
        ...
        when(itemRepository.findDistinctTopByOwner(any()))
                .thenReturn(item1);
        when(bookingRepository.findByItemAndStartBeforeAndEndAfter(any(), any(), any()))
                .thenReturn(booking);
